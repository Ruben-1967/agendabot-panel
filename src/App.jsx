...
import ConectarFacebook from './pages/admin/ConectarFacebook';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="tabla-citas" element={<TablaCitas />} />
        ...
        <Route path="conectar-facebook" element={<ConectarFacebook />} />
    ...
    <Route
      ...
      />
      <Route
        path="/vendedor/admin/excedente-citas"
        element={
          <ProtectedRouteVendedorAdmin>
            <ExcedenteCitas />
          </ProtectedRouteVendedorAdmin>
      ...
      />
      <Route
        path="/vendedor/admin/catalogo-demo"
        element={
          <ProtectedRouteVendedorAdmin>
            <CatalogoVisualDemoAdmin />
          </ProtectedRouteVendedorAdmin>
        }
      />
